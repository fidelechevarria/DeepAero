...
import sys
from PySide2.QtCore import(Property, QObject, QPropertyAnimation, Signal, Slot, QUrl)
...
class Window(Qt3DExtras.Qt3DWindow):
    ...
    def createScene(self):
        ...
        self.torusTransform.setTranslation(QVector3D(1, 1, 1))
        ...
        self.torusEntity.addComponent(self.sphereTransform)
